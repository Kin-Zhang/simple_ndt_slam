...
parser.add_argument('--bag-path', default='/home/kin/bags/autoware/res_odom_lidar.bag')
parser.add_argument('--save-dir', default='/home/kin/bags/autoware/res_odom_lidar')
